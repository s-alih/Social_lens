 ...
 *
 * @notice This is the standard interface for all Lens-compatible CollectModule.
 */
...
interface ICollectModule {
     ...
     * @param data Arbitarary data __passed from the user!__ to be decoded.
     *
     * @return bytes An abi encoded byte array encapsulating the execution's state changes. This will be emited by the
     * hub alongside the collect module's address and should be consumed by the front ends.
     */
