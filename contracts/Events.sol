...
library Events{
    ...
    /**
     * @dev Emitted when the NFT contracts's name and symbol are set at initialization.abi
     * 
     * @param name The NFT name set
     * @param symbol The NFT symobol set 
    ...
    /**
     * @dev Emited when a profile is created.
     * 
     ...
     * @param followModule The profile's newly set follow module.
     * @param followModuleReturnData The data returned from the follow module's initialization. this is and totally depends on the follow module chosen.
     * @param followNFTURI The URI for the profile's follow NFT.
     * @param timestamp The current block timestamp
     */
    ...
    /**
     * @dev Emited when a newly deployed follow NFT is initialized.
     * 
     * @param profileId The token ID of the profile connected to this follow NFT.
     * @param timestamp The current block timestamp
     */

    event FollwNFTInitialized(uint256 indexed profileId, uint256 timestamp);
