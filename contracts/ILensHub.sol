...
interface ILensHub{
    ...
    /**
     * @notice Initialize the LensHub NFT, setting the inital governance address as wll as the name and symbol in
     * the LensNFTBase contract.
     * 
     * @param name The name to set for the hub NFT.
     * @param symbol The symbol to set for the hub NFT.
     * @param newGovernance The governance adddress to set.
     */
     ...
     * governance address
     * 
     * @param referenceModule The reference module contract to add or removefrom whitelist
     * @param whitelist Whether or not the reference module should be whitelisted .
     */

    function whitelistReferenceModule(address referenceMoudle, bool whitelist)external;
    ...
    /**
     * @notice Follow the given profile, executing each profile's follow module logic (if any) and minting followNFTs to the caller.
     * 
     * NOTE: Both the `profileIds` and  `datas` arrays must be of the same length, regardaless if the profile do not have a follow module set.
     * 
     * @param profileIds The token ID array of the profile to follow.
     * @param datas The arbitarary data array to pass to the follow module for each profile if need.
     * 
     * @return uint256[] An array of integers representing the minted follw NFT's token IDs.
     */
    ...
    /**
     * @dev Helper function to emit a detailed follwNFT transfer event from the hub, to be consumed by frontends to track 
     * followNFT transfers.
     * 
     * @param profileId The token ID of the profile associated with the followNFT being transfered.
     * @param followNFTId the followNFT being transfered's token ID.
